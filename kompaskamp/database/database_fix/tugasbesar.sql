...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 02, 2025 at 08:48 PM
...
(11, 'Saran', 'Website Responsif', 'Mohon agar website dapat diakses lebih cepat di perangkat mobile.'),
(12, 'Keluhan', 'Bug pada Formulir', 'Formulir pendaftaran tidak dapat menyimpan data saat diisi.'),
(13, 'Pujian', 'UI/UX yang Bagus', 'Desain antarmuka sangat mudah dipahami dan menarik.');
...
INSERT INTO `feedbacks` (`id`, `title`, `content`, `category`, `created_at`) VALUES
(1, 'Saran UI', 'Mohon tambahkan tema gelap untuk kenyamanan pengguna.', 'Saran', '2025-01-02 00:25:08'),
(2, 'Bug Report', 'Terdapat error saat mencoba mengunggah file.', 'Bug', '2025-01-02 00:25:08'),
(3, 'Pujian', 'Aplikasi sangat membantu untuk registrasi kampus.', 'Pujian', '2025-01-02 00:25:08'),
(4, 'Pertanyaan', 'Kapan fitur baru akan dirilis?', 'Pertanyaan', '2025-01-02 00:25:08'),
(5, 'asdf', 'asdf', 'ui', '2025-01-02 01:03:44'),
(6, 'asdf', 'asdf', 'performance', '2025-01-02 01:03:56'),
(7, 'tyh', 'dfgh', 'accuracy', '2025-01-02 14:44:51'),
(8, 'dghdghdg', 'hdghdhd', 'performance', '2025-01-02 14:44:57');
